...
module YandexHelper = 
    ...
    let private translateApiKey = BookMate.ApplicationConfiguration.Configuration.getYandexTranslateApiKey
    let private translateApiEndPoint =  BookMate.ApplicationConfiguration.Configuration.getYandexTranslateApiEndPoint
    let private dictionaryApiKey = BookMate.ApplicationConfiguration.Configuration.getYandexDictionaryApiKey
    let private dictionaryApiEndPoint = BookMate.ApplicationConfiguration.Configuration.getYandexDictionaryApiEndPoint
